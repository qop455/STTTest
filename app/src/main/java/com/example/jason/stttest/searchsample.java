...
public class searchsample {
    ...
    public static void main(String[] args) {
        ...
        try {
            InputStream in = searchsample.class.getResourceAsStream("/" + PROPERTIES_FILENAME);
            properties.load(in);
        ...
        try {
            ...
            if (searchResultList != null) {
                ...
                List<MediaStore.Video> videoList = listResponse.getItems();
     ...
     */
    private static void prettyPrint(Iterator<MediaStore.Video> iteratorVideoResults, String query) {
        ...
        while (iteratorVideoResults.hasNext()) {
            ...
            MediaStore.Video singleVideo = iteratorVideoResults.next();
